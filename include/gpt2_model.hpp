...
namespace gpt2 {
    ...
    void activations_init(Activations& a, const GPT2Config& cfg, int logit_rows);
    ...
    void lm_head(const GPT2Weights& w, Activations& a, int n_real, bool all_positions, const char* dump_dir = nullptr);
